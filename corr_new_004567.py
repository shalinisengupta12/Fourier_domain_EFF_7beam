...
def write_samps_bad(f8,filterbank1,beam):
	with open(filterbank1+'beam%s/'%(beam)+'bad_00_all_samps_comb.txt', 'a') as fh:	
...
#	for i in range(0,2,1):
	...
	for z1 in range(0,21,1):
        	q=c[z1]
                if c[z1][2]==0 and c[z1][3]==1:
                	cor.append(c[z1])
		if c[z1][2]==0 and c[z1][3]==2:
                        cor.append(c[z1])
		if c[z1][2]==0 and c[z1][3]==3:
                        cor.append(c[z1])
		if c[z1][2]==0 and c[z1][3]==4:
                        cor.append(c[z1])
		if c[z1][2]==0 and c[z1][3]==5:
                        cor.append(c[z1])
	...
	fin0=np.array(final0[hel:l-hel])
	fin1=np.array(ff1)
	fin2=np.array(ff2)
	fin3=np.array(ff3)
	fin4=np.array(ff4)
	...
	for i in range(0,len(bins),1):
		...
		for mm0 in range(0, len(b), 1):
			r, r0, r1, r2, r3, r4, r5, r6=four_beam(b[mm0], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
...
# ===================================================================== 5 beam comparison ==================================================================================================================
		...
		bb1=list(itertools.combinations(a, 5))
                for mm1 in range(0, len(bb1), 1):
                        ss, ss0, ss1, ss2, ss3, ss4, ss5, ss6=five_beam(bb1[mm1], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
...
# ======================================================================== 6 beam comaprison ==============================================================================================================
		...
		bb2=list(itertools.combinations(a, 6))
                for mm2 in range(0, len(bb2), 1):
                        rr, rr0, rr1, rr2, rr3, rr4, rr5, rr6=six_beam(bb2[mm2], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
...
# ================================================================================= 7 beam comparison ======================================================================================================
		...
		cou5=0
		cou6=0
		bb3=list(itertools.combinations(a, 7))
                for mm3 in range(0, len(bb3), 1):
                        tt, tt0, tt1, tt2, tt3, tt4, tt5, tt6=seven_beam(bb3[mm3], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
