...
def write_samps_bad(f8,filterbank1,beam):
	with open(filterbank1+'beam%s/'%(beam)+'bad_04_all_samps_comb.txt', 'a') as fh:	
...
#	for i in range(0,2,1):
	...
	for z1 in range(0,21,1):
		...
		if c[z1][2]==1 and c[z1][3]==4:
                        cor.append(c[z1])
		if c[z1][2]==2 and c[z1][3]==4:
                        cor.append(c[z1])
		if c[z1][2]==3 and c[z1][3]==4:
                        cor.append(c[z1])
		if c[z1][2]==4 and c[z1][3]==5:
                        cor.append(c[z1])
	...
	fin2=np.array(ff2)
	fin3=np.array(ff3)
	fin4=np.array(final4[hel:l-hel])
	fin5=np.array(ff5)
	fin6=np.array(ff6)
...
# ======================================================================== 5 beam comparison ===============================================================================================================
		...
		cou6=0
		a=[fin0[j], fin1[j],fin2[j],fin3[j],fin4[j],fin5[j],fin6[j]]
		bb2=list(itertools.combinations(a, 5))
		for mm2 in range(0, len(bb2), 1):
			rr, rr0, rr1, rr2, rr3, rr4, rr5, rr6=five_beam(bb2[mm2], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
