...
def write_samps_bad(f8,filterbank1,beam):
	with open(filterbank1+'beam%s/'%(beam)+'bad_06_all_samps_comb.txt', 'a') as fh:	
...
#	for i in range(0,2,1):
	...
	for z1 in range(0,21,1):
        	q=c[z1]
                if c[z1][2]==0 and c[z1][3]==6:
                	cor.append(c[z1])
		if c[z1][2]==1 and c[z1][3]==6:
                        cor.append(c[z1])
		if c[z1][2]==2 and c[z1][3]==6:
                        cor.append(c[z1])
		if c[z1][2]==3 and c[z1][3]==6:
                        cor.append(c[z1])
		if c[z1][2]==4 and c[z1][3]==6:
                        cor.append(c[z1])
		if c[z1][2]==5 and c[z1][3]==6:
                        cor.append(c[z1])
	...
	for f in range(hel, l-hel, 1):
		...
		ff1.append(final1[f-corr[1]])
		ff2.append(final2[f-corr[2]])
		ff3.append(final3[f-corr[3]])
		ff4.append(final4[f-corr[4]])
		ff5.append(final5[f-corr[5]])
	...
	fin4=np.array(ff4)
	fin5=np.array(ff5)
	fin6=np.array(final6[hel:l-hel])
	...
	for i in range(0,len(bins),1):
		...
		for mm2 in range(0, len(b), 1):
			r, r0, r1, r2, r3, r4, r5, r6=four_beam(b[mm2], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
		...
		dd2=1
                ...
                if counter==0:
                        ...
                        if counter1>0:
                                bf1.append(j+hel-corr[1])
                        if counter2>0:
                                bf2.append(j+hel-corr[2])
                        if counter3>0:
                                bf3.append(j+hel-corr[3])
                        if counter4>0:
                                bf4.append(j+hel-corr[4])
                        if counter5>0:
                                bf5.append(j+hel-corr[5])
                        if counter6>0:
                                bf6.append(j+hel)
...
## =========================================================================== 5 beam comparison ===========================================================================================================
		...
		for mm in range(0, len(bb), 1):
			rr, rr0, rr1, rr2, rr3, rr4, rr5, rr6=five_beam(bb[mm], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
...
# ========================================================================== 6 beam comparison =============================================================================================================
		...
		coun6=0
		a=[fin0[j], fin1[j],fin2[j],fin3[j],fin4[j],fin5[j],fin6[j]]
		bb0=list(itertools.combinations(a, 6))
		for mm0 in range(0, len(bb0), 1):
			ss, ss0, ss1, ss2, ss3, ss4, ss5, ss6 = six_beam(bb0[mm0], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
...
# =============================================================================== 7 beam comparison ========================================================================================================
		...
		cou6=0
		a=[fin0[j], fin1[j],fin2[j],fin3[j],fin4[j],fin5[j],fin6[j]]
		bb1=list(itertools.combinations(a, 7))
		for mm1 in range(0, len(bb1), 1):
			tt, tt0, tt1, tt2, tt3, tt4, tt5, tt6 = seven_beam(bb1[mm1], fin0[j], fin1[j], fin2[j], fin3[j], fin4[j], fin5[j], fin6[j], sd0,sd1,sd2,sd3,sd4,sd5,sd6,md0,md1,md2,md3,md4,md5,md6)
...
#final step outputting the modified filterbank files
	...
	print ('for 0 beam:freq, time ',len(bf0))
        print ('for 1 beam:freq, time ',len(bf1))
	print ('for 2 beam:freq, time ',len(bf2))
	print ('for 3 beam:freq, time ',len(bf3))
	print ('for 4 beam:freq, time ',len(bf4))
	print ('for 5 beam:freq, time ',len(bf5))
	print ('for 6 beam:freq, time ',len(bf6))
